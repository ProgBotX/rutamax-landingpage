        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex gap-3 mt-6">
                <div className="w-8 h-8 rounded-lg bg-transit-800/50 border border-transit-700/30 flex items-center justify-center text-slate-300 hover:text-transit-cyan hover:border-transit-cyan/30 transition-all duration-200 cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-sm text-slate-300 hover:text-transit-cyan transition-colors duration-200 flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-transit-cyan/40" />
                  Inicio
                </Link>
              </li>
              <li>
                <Link to="/downloads" className="text-sm text-slate-300 hover:text-transit-cyan transition-colors duration-200 flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-transit-cyan/40" />
                  Descargas
                </Link>
              </li>
              <li>
                <a href="#features" className="text-sm text-slate-300 hover:text-transit-cyan transition-colors duration-200 flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-transit-cyan/40" />
                  Características
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/" className="text-sm text-slate-300 hover:text-transit-cyan transition-colors duration-200 flex items-center gap-2">
