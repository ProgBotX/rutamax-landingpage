...
const versionsData: VersionData[] = [
  ...
  {
    id: 9,
    version: "Riftara v0.5.0-alpha",
    lastUpdate: "06 mayo, 2026",
    status: "Estable",
    statusColor: "green", // Este valor lo usaremos para el color del badge.
    changes: [
      "Mejora los resultados del motor de rutas",
      "Redimiento optimizado de la aplicación",
      "Mejora la estimación de tiempos",
    ],
    download: {
      platform: "Android",
      url: "https://www.dropbox.com/scl/fi/ss5mch18qsv12l6mhhqs8/20260506-riftara-v0.5.0-alpha.apk?rlkey=yo2ykla5r8e4akldcs7qnvyhs&st=a2aziv4b&dl=1",
      disabled: false
    }
  },
];
