...
const Downloads = () => {
  return (
    <div className="relative min-h-screen bg-transit-900 overflow-hidden pt-20">
      ...
      <div className="relative py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm text-slate-300 hover:text-transit-cyan transition-colors duration-200 mb-12 group"
          >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-6 md:gap-8 md:grid-cols-2 lg:grid-cols-3">
              {versionsData
                ...
                .sort((a, b) => b.id - a.id)
                .map((version) => (
                  <DownloadCard key={version.id} data={version} darker />
                ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 text-center">
          <p className="text-sm text-slate-400 mb-4">¿No encuentras lo que buscas?</p>
          <a href="mailto:riftaragps@gmail.com" className="btn-secondary inline-flex">
